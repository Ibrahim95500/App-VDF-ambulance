...
async function seed() {
    try {
        ...
        const mainUsers = [
            ...
            ['hamid-id', 'ambulancemark@gmail.com', 'Hamid CHEIKH', 'Hamid', 'CHEIKH', '{"ADMIN"}', false, HAMID_HASH, null, null, null, null, false],
            ['rezan-id', 'rezan.selva@gmail.com', 'Rezan SELVA', 'Rezan', 'SELVA', '{"ADMIN"}', false, REZAN_HASH, null, null, null, null, false],
