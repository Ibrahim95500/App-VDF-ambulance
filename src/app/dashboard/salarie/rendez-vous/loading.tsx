    ...
    return (
        <div className="flex flex-col gap-5 lg:gap-7.5 max-w-5xl mx-auto w-full px-4 sm:px-0 animate-pulse">
            <div className="flex items-center gap-3 mb-2">
                ...
                <div className="h-8 w-64 bg-secondary/20 rounded-md" />
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5 lg:gap-7.5 mt-2">
                <div className="lg:col-span-1 xl:col-span-1">
                    <div className="flex flex-col rounded-xl border border-border h-80 bg-muted/20">
