    ...
    return (
        <Container className="py-8 space-y-8">
            <div className="flex bg-card text-card-foreground flex-col rounded-xl shadow-sm border border-border border-t-2 border-orange-500 pb-5">
                <div className="px-5 py-4 flex justify-between items-center border-b border-border bg-orange-50/50">
                    <h2 className="text-lg font-bold text-orange-700">Gestion des Demandes de Service</h2>
                </div>
                <div className="p-0">
